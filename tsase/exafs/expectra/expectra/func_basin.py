...
from expectra.function import hypoboloid
...
#        self.log(-1, self.Umin, self.chi_deviation, self.Umin,self.Umin)
    ...
    def run(self, steps):
        ...
        Uo = hypoboloid(chi_devi_o, Eo, alpha)
        ...
        for step in range(steps):
            ...
            while Un is None:
                ...
                if np.sometrue(rn != ro):
                    ...
                    Un = hypoboloid(chi_devi_n, En, alpha)
                    self.log_chi(step)
                else:
                    Un = hypoboloid(self.chi_deviation, self.energy, alpha)
